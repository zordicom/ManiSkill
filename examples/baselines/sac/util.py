"""
Utility functions for SAC training, including Expert+Residual environment creation.
"""
...
def create_expert_residual_envs(args, env_kwargs, device):
    ...
    # Create expert policy using the centralized create_expert_policy function
    expert_kwargs = {}
    ...
    # Create expert policy using experts.py (handles PPO state, PPO RGB, IK, ACT, etc.)
