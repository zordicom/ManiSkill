...
def _main(args, proc_id: int = 0, start_seed: int = 0) -> str:
    ...
    # Set robot_uids for environments that support it
    env_kwargs = {
    ...
    # Explicitly set robot for PickBox to use Panda and disable shadows
    if env_id == "PickBox-v1":
        env_kwargs["robot_uids"] = "panda"
        env_kwargs["enable_shadow"] = False
